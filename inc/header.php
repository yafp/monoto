...
<div ID="logo">
	<a href="notes.php"><img src="images/icons/transparent.gif" alt="monoto logo" title="Reloads the main page" width="200px" height="98px"></a>
	...
	<?php
		...
		// show shortcut-icon if logged in
		if((curPageName() != "index.php") and (curPageName() != "redirect.php") and (curPageName() != "logout.php")) 
		{
			echo "<a class='modal' href='javascript:void(0);''><img src='images/icons/keyboard.png' alt='keyboard shortcuts popup' title='keyboard shortcuts' width='25px'></a>";
		}
	?>
...
<?php 
	...
	if($_SESSION['valid'] == 1) // is valid
	{
		...
		echo '<div id="neuNav">';
			...
			{
				echo '<li><a accesskey="r" href="random.php"><b>r</b>andom image</a></li>';
			}
			...
			//echo "<li><a class='modal' href='javascript:void(0);''><img src='images/icons/keyboard.png' alt='keyboard shortcuts popup' title='keyboard shortcuts' width='25px'></a><li></ul>";
			//echo "<a class='modal' href='javascript:void(0);''><img src='images/icons/keyboard.png' alt='keyboard shortcuts popup' title='keyboard shortcuts' width='25px'></a>";
		echo '</div>';
	}
